...
?>
	...
	switch ($action){
		case "add":
			...
			$sql="INSERT INTO `sys:group`(name,aid,account,state,description,dateline,config,module,widget,medal) VALUES('".$name."',".$_G['manager']['id'].",'".$_G['manager']['account']."',".$state.",'".$description."',".time().",'".$config."','".$module."','".$widget."','".$medal."')";
