...
?>
	...
	<dl id="panel">
        ...
        <dd>
        	<ul>
            	<li><a href="#link=system.setting.php?do=global" rel="first"><img src="<?php echo VI_BASE.'static/image/extra/settings.png';?>" class="icon" />全局设置</a></li><li><a href="#link=system.setting.php?do=attach"><img src="<?php echo VI_BASE.'static/image/extra/installer.png';?>" class="icon" />附件设置</a></li><li><a href="#link=system.setting.php?do=mail"><img src="<?php echo VI_BASE.'static/image/extra/mail.png';?>" class="icon" />邮件设置</a></li><li><a href="#link=data.district.php"><img src="<?php echo VI_BASE.'static/image/extra/safari.png';?>" class="icon" />区域管理</a></li><li><a href="#link=data.update.php" data-mark="upgrade"><img src="<?php echo VI_BASE.'static/image/extra/timecapsule.png';?>" class="icon" />更新管理</a></li><li><a href="#link=data.backup.php"><img src="<?php echo VI_BASE.'static/image/extra/services.png';?>" class="icon" />数据备份</a></li><li><a href="#link=system.server.php" data-mark="status"><img src="<?php echo VI_BASE.'static/image/extra/term1.png';?>" class="icon" />系统信息</a></li><li><a href="#link=system.licence.php"><img src="<?php echo VI_BASE.'static/image/extra/superpong.png';?>" class="icon" />版本验证</a></li></ul>
        </dd>
